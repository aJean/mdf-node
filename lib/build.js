...
var _main = _interopRequireDefault(require("./nestjs/main"));
  ...
  api.registerCommand({
    ...
    fn() {
      return _asyncToGenerator(function* () {
        ...
        const spinner = new _utils2.Spinner({
          text: 'start to build'
        }).info(); // 清空 dist

        rimraf.sync(tscPaths.absOutDir); // 创建 node 入口

        (0, _main.default)(api); // 混合项目需要先构建 client
