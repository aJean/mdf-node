import { Core, Express, Logger, Helper } from '@mdfjs/node';
...
{{#uselog}}
import { Winston, WinstonModule, utilities } from '@mdfjs/node';
{{/uselog}}
...
@Global()
@Module({
  imports: [SharedModule.forRoot({{{ shared }}}), ...AppModule.imports],
  providers: [
    Logger,
    {
